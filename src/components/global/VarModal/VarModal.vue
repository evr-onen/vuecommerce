  ...
  <div class="catContent mt-8 min-h-[30rem]">
    <div class="tabHeaders flex h-10">
      <div
        ...
        @click="tabIndex = 0"
      >
        <p class="m-auto text-lg">Variant Propertise</p>
      </div>
      <div
        ...
        @click="tabIndex = 1"
      >
        <p class="m-auto text-lg">Variant Type</p>
      </div>
    </div>
    ...
    <div class="tabContents h-[30rem] flex relative overflow-hidden">
      ...
      >
        <AddVarProp :isOpen="isOpen" @closeModal="closeModalHandler" />
      </div>
      <div class="tabContent-2 h-full" :class="{ 'tabContent-2_active': tabIndex === 1 }">
        <AddVarType :isOpen="isOpen" @closeModal="closeModalHandler" />
      </div>
    </div>
  </div>
</template>
...
import AddVarType from './AddVarType.vue'
import AddVarProp from './AddVarProp.vue'
